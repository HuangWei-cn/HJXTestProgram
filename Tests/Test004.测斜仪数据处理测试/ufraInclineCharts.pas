...
procedure TfraInclineCharts.piCopyTwoChartClick(Sender: TObject);
var
    jpg     : TJPEGImage;
    bmp     : TBitmap;
    AFormat : word;
...
procedure TfraInclineCharts.piSaveToFileClick(Sender: TObject);
var
    jpg: TJPEGImage;
    bmp: TBitmap;
begin
