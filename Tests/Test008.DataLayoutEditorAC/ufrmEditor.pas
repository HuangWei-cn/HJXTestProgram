...
type
  TfrmEditor = class(TForm)
    ...
    procedure actAlignUpdate(Sender: TObject);
  private
...
procedure TfrmEditor.actAlignUpdate(Sender: TObject);
begin
  actAlign.Enabled := sgLayout.SelectedObjects.Count > 1;
end;
...
procedure TfrmEditor.actPropertyUpdate(Sender: TObject);
begin
  actProperty.Enabled := sgLayout.SelectedObjects.Count > 0;
end;
...
procedure TfrmEditor.actSendToBackUpdate(Sender: TObject);
begin
  actSendToBack.Enabled := sgLayout.SelectedObjects.Count > 0;
end;
